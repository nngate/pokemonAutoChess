...
export declare const networkSlice: import("@reduxjs/toolkit").Slice<INetwork, {
    ...
    requestLeaderboard: (state: import("immer").WritableDraft<INetwork>) => void;
    requestBotLeaderboard: (state: import("immer").WritableDraft<INetwork>) => void;
    requestLevelLeaderboard: (state: import("immer").WritableDraft<INetwork>) => void;
...
export declare const selectLanguage: import("@reduxjs/toolkit").ActionCreatorWithPayload<Language, "network/selectLanguage">, unban: import("@reduxjs/toolkit").ActionCreatorWithPayload<{
    ...
    uid: string;
    reason: string;
}, "network/ban">, pokemonPropositionClick: import("@reduxjs/toolkit").ActionCreatorWithPayload<PkmProposition, "network/pokemonPropositionClick">, requestLeaderboard: import("@reduxjs/toolkit").ActionCreatorWithoutPayload<"network/requestLeaderboard">, requestBotLeaderboard: import("@reduxjs/toolkit").ActionCreatorWithoutPayload<"network/requestBotLeaderboard">, requestLevelLeaderboard: import("@reduxjs/toolkit").ActionCreatorWithoutPayload<"network/requestLevelLeaderboard">, giveTitle: import("@reduxjs/toolkit").ActionCreatorWithPayload<{
    uid: string;
    title: Title;
