...
function SynergyDetailComponent(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { style: { maxWidth: "480px" }, children: [(0, jsx_runtime_1.jsxs)("div", { style: { display: "flex", alignItems: "center" }, children: [(0, jsx_runtime_1.jsx)(synergy_icon_1.default, { type: props.type, size: "40px" }), (0, jsx_runtime_1.jsx)("h3", { style: { margin: 0 }, children: t(`synergy.${props.type}`) })] }), (0, jsx_runtime_1.jsx)("p", { style: { whiteSpace: "pre-wrap" }, children: (0, descriptions_1.addIconsToDescription)(t(`synergy_description.${props.type}`, { additionalInfo })) }), Synergy_1.SynergyEffects[props.type].map((d, i) => {
                return ((0, jsx_runtime_1.jsxs)("div", { style: {
                        ...
                        borderRadius: "12px",
                        padding: "5px"
                    }, children: [(0, jsx_runtime_1.jsxs)("h4", { style: { fontSize: "1.2em" }, children: ["(", Config_1.SynergyTriggers[props.type][i], ") ", t(`effect.${d}`)] }), (0, jsx_runtime_1.jsx)(effect_description_1.EffectDescriptionComponent, { effect: d })] }, d));
