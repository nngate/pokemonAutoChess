...
function GamePokemonDetail(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "game-pokemon-detail in-shop", children: [(0, jsx_runtime_1.jsx)("img", { className: "game-pokemon-detail-portrait", style: { borderColor: Config_1.RarityColor[pokemon.rarity] }, src: (0, utils_1.getPortraitSrc)(pokemon.index, (_a = props.shiny) !== null && _a !== void 0 ? _a : pokemon.shiny, (_b = props.emotion) !== null && _b !== void 0 ? _b : pokemon.emotion) }), (0, jsx_runtime_1.jsxs)("div", { className: "game-pokemon-detail-entry", children: [(0, jsx_runtime_1.jsx)("p", { className: "game-pokemon-detail-entry-name", children: t(`pkm.${pokemon.name}`) }), (0, jsx_runtime_1.jsx)("p", { className: "game-pokemon-detail-entry-rarity", style: { color: Config_1.RarityColor[pokemon.rarity] }, children: t(`rarity.${pokemon.rarity}`) }), (0, jsx_runtime_1.jsxs)("p", { className: "game-pokemon-detail-entry-tier", children: [Array.from({ length: pokemon.stars }, (_, index) => ((0, jsx_runtime_1.jsx)("img", { src: "assets/ui/star.svg", height: "16" }, index))), Array.from({ length: (0, precomputed_pokemon_data_1.getPokemonData)(pokemon.name).stages - pokemon.stars }, (_, index) => ((0, jsx_runtime_1.jsx)("img", { src: "assets/ui/star_empty.svg", height: "16" }, index)))] })] }), (0, jsx_runtime_1.jsx)("div", { className: "game-pokemon-detail-types", children: Array.from(pokemon.types.values()).map((type) => ((0, jsx_runtime_1.jsx)(synergy_icon_1.default, { type: type }, type))) }), (0, jsx_runtime_1.jsx)("div", { className: "game-pokemon-detail-stats", children: pokemonStats.map(({ stat, value }) => ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("img", { src: `assets/icons/${stat}.png`, alt: stat, title: t(`stat.${stat}`) }), (0, jsx_runtime_1.jsx)("p", { children: value })] }, stat))) }), pokemon.passive !== Passive_1.Passive.NONE && ((0, jsx_runtime_1.jsx)("div", { className: "game-pokemon-detail-passive", children: (0, jsx_runtime_1.jsx)("p", { children: (0, descriptions_1.addIconsToDescription)(t(`passive_description.${pokemon.passive}`)) }) })), pokemon.skill !== Ability_1.Ability.DEFAULT && ((0, jsx_runtime_1.jsxs)("div", { className: "game-pokemon-detail-ult", children: [(0, jsx_runtime_1.jsx)("div", { className: "ability-name", children: (0, jsx_runtime_1.jsx)("p", { children: t(`ability.${pokemon.skill}`) }) }), (0, jsx_runtime_1.jsx)("div", { children: (0, jsx_runtime_1.jsx)(ability_tooltip_1.AbilityTooltip, { ability: pokemon.skill, tier: pokemon.stars }, pokemon.id) })] }))] }));
}
