...
function UnownPanel(props) {
    ...
    const unowns = (0, react_1.useMemo)(() => Pokemon_1.Unowns.flatMap((pkm) => {
        const config = pokemonCollection.find((p) => p.id === Pokemon_1.PkmIndex[pkm]);
        const { emotions, shinyEmotions } = config !== null && config !== void 0 ? config : {
            dust: 0,
            emotions: [],
            shinyEmotions: []
        };
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("div", { id: "unown-panel", children: secretMessage.map((char, i) => renderChar(char, i, unowns)) }), (0, jsx_runtime_1.jsx)("div", { className: "pokemon-carousel", children: unowns.map((unown) => {
                    if (!unown)
                        return null;
