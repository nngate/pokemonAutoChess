...
function GamePlayer(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { style: {
        ...
        }), onClick: playerClick, "data-tooltip-id": "detail-" + props.player.id, children: [(0, jsx_runtime_1.jsx)(react_circular_progressbar_1.CircularProgressbarWithChildren, { value: props.player.life }), (0, jsx_runtime_1.jsx)("div", { className: "my-container life-text", children: props.player.life }), (0, jsx_runtime_1.jsx)(react_tooltip_1.Tooltip, { id: "detail-" + props.player.id, className: "custom-theme-tooltip", place: "left", "data-tooltip-offset": { left: 30, bottom: props.index === 0 ? 50 : 0 }, children: (0, jsx_runtime_1.jsx)(game_player_detail_1.default, { name: props.player.name, life: props.player.life, money: props.player.money, level: props.player.experienceManager.level, history: props.player.history, synergies: props.player.synergies }) })] }));
}
