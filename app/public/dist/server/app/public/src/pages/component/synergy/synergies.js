...
function Synergies(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "synergies-container my-container", children: [(0, jsx_runtime_1.jsx)("h2", { className: "synergies-header", children: t("synergies") }), Object.keys(Synergy_1.Synergy)
                .sort((a, b) => {
                ...
                if (s && s[1] > 0) {
                    return ((0, jsx_runtime_1.jsx)(synergy_component_1.default, { type: type, value: s[1], index: index }, type));
                }
                else {
                    return null;
                }
