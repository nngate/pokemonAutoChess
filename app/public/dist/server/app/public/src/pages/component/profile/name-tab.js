...
function NameTab() {
    ...
    return user ? ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("h3", { children: t("change_name") }), (0, jsx_runtime_1.jsxs)("div", { style: { display: "flex", gap: "0.5em" }, children: [(0, jsx_runtime_1.jsx)("input", { type: "text", placeholder: user.name, onChange: (e) => {
